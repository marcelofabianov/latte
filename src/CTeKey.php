...
final class CTeKey
{
    ...
    protected static function validModel(int $model): bool
    {
    ...
    public static function isValid(string $value): bool
    {
        ...
        if ($key['numbers'] < 1 or $key['numbers'] > 999999999) {
            self::$message = 'Numbers invalid';

            return false;
        }

        if (! self::validModel((int) $key['model'])) {
            self::$message = 'Model invalid';
